...
| EON-C13 | Eon applies one bounded terminal-background opacity from its canonical configuration whenever it creates an Eon or EonTerm Venus surface, while preserving live presentation and Orbit Session ownership | Eon | Candidate | Consumes exact Venus `VEN-C11` source `74ab5a0b661210f0afec94086f5358fe50b01f05`; verified working tree pending immutable proof |
