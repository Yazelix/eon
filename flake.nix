{
  ...
  inputs = {
    ...
    orbit = {
      url = "git+https://github.com/Yazelix/eon-sessions.git?rev=ea9fd28ce0908f218cf65d4e6df368f0a4e565f5";
      flake = false;
    };
    venus = {
      url = "git+https://github.com/Yazelix/eon-desktop.git?rev=b7404dae6c59a8e6de6ca9efbf2c907eedf1262b";
      flake = false;
    };
    helix = {
