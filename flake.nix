{
  ...
  inputs = {
    ...
    orbit = {
      url = "git+https://github.com/Yazelix/eon-sessions.git?rev=0ca0cc93b83793d08eadcca7eac6e947a80ce25d";
      flake = false;
    };
    venus = {
      url = "git+https://github.com/Yazelix/eon-desktop.git?rev=ab24961bd6b2f9403736e52ebbac8cc266488a41";
      flake = false;
    };
    helix = {
