{
  ...
  inputs = {
    ...
    orbit = {
      url = "git+https://github.com/Yazelix/eon-sessions.git?rev=2518512758c7848bbd87f907b105c8bcf0fc4e1b";
      flake = false;
    };
    venus = {
      url = "git+https://github.com/Yazelix/eon-desktop.git?rev=a84016532c51cbebabb185d53b7a108a64873178";
      flake = false;
    };
    helix = {
